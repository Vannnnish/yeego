...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/vannnnish/yeego/yeethird/alidayu/request"
	"io"
	"io/ioutil"
	"net/http"
	"net/url"
...
const (
	// 正式的http请求接口
	ProHTTPGateWayURL string = "yeehttp://gw.api.taobao.com/router/rest"
	// 沙箱http请求接口
	DebugHTTPGateWayURL string = "yeehttp://gw.api.tbsandbox.com/router/rest"
	// 正式的https请求接口

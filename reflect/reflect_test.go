...
func TestGetTypeFullName(t *testing.T) {
	yeego.Equal(reflect.GetTypeFullName(reflect.TypeOf("")), "string")
	yeego.Equal(reflect.GetTypeFullName(reflect.TypeOf(1)), "int")
	yeego.Equal(reflect.GetTypeFullName(reflect.TypeOf(&a{})),
		"_/Users/angelina/Workspace/golib/src/yeego/yeeReflect_test.a")
}

func TestIndirectType(t *testing.T) {
	yeego.Equal(reflect.IndirectType(reflect.TypeOf(&a{})), reflect.TypeOf(a{}))
}
...
func TestStructGetAllField(t *testing.T) {
	fileds := reflect.StructGetAllField(reflect.TypeOf(&GetAllFieldT1{}))
...
func TestGetTypeFullName2(t *testing.T) {
	...
	fields := reflect.StructGetAllField(reflect.TypeOf(fieldT3))
